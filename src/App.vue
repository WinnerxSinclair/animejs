...
onMounted(() => {
  const timelineStick = anime.timeline({
    easing: 'linear'
  });
  const timelineCue = anime.timeline({
    easing: 'linear'
  });
  const timelineOne = anime.timeline({
    easing: 'linear'
  });
  ...
  const timelineSix = anime.timeline({
    easing: 'linear'
  });
  const timelineSeven = anime.timeline({
    easing: 'linear'
  });
  const timelineEight = anime.timeline({
    easing: 'linear'
  });
  const timelineNine = anime.timeline({
    easing: 'linear'
  });
  timelineStick
    .add({
    ...
    .add({
      ...
      keyframes: [
        {opacity: 0,delay: 200},
        {translateX: -305, rotate: '-150deg', translateY: 318},
    ...
    .add({
      targets: '.stick',
      keyframes: [
        {translateX: -330, translateY: 370, duration: 1100},
        {translateX: -300, translateY: 310, duration: 100}
      ] 
    })
    .add({
      targets: '.stick',
      keyframes: [
        {opacity: 0,delay: 200},
        {translateX: -58, rotate: '15deg', translateY: 110},
    ...
    .add({
      targets: '.stick',
      keyframes: [
        {translateX: -10, translateY: 160, duration: 1100},
        {translateX: -60, translateY: 110,  duration: 100}
      ] 
    })
    .add({
      targets: '.stick',
      keyframes: [
        {opacity: 0,delay: 200},
        {translateX: -100, rotate: '-30deg', translateY: -160},
        {opacity:1, delay: 2800}
      ]
    })
    .add({
      targets: '.stick',
      keyframes: [
        {translateX: -80, translateY: -200, duration: 1100},
        {translateX: -120, translateY: -120,  duration: 100}
      ] 
    })
    .add({
      targets: '.stick',
      keyframes: [
        {opacity: 0,delay: 200},
        {translateX: -105, rotate: '-45deg', translateY: -300},
        {opacity:1, delay: 2800}
      ]
    })
    .add({
      targets: '.stick',
      keyframes: [
        {translateX: -50, translateY: -450, duration: 1100},
        {translateX: -115, translateY: -270,  duration: 100}
      ] 
    })
    .add({
      targets: '.stick',
      keyframes: [
        {opacity: 0,delay: 200},
        {translateX: -290, rotate: '-165deg', translateY: -40},
        {opacity:1, delay: 2800}
      ]
    })
    .add({
      targets: '.stick',
      keyframes: [
        {translateX: -310, translateY: -25, duration: 1100},
        {translateX: -285, translateY: -40,  duration: 100}
      ] 
    })
    .add({
      targets: '.stick',
      keyframes: [
        {opacity: 0,delay: 200},
        {translateX: -13, rotate: '65deg', translateY:671},
        {opacity:1, delay: 2800}
      ]
    })
    .add({
      targets: '.stick',
      keyframes: [
        {translateX:82, translateY: 1000, duration: 1100},
        {translateX: -13, translateY: 671,  duration: 100}
      ] 
    })
  ...
  .add({
    ...
    keyframes: [
      ...
      { translateX: -185, translateY: -243, duration: 2000, easing: 'easeOutSine', delay: 31000},
      { opacity: 0, delay: 200 }
    ],
  })
